...
public class StudentManagement implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            DbOperations.getAllStudents().forEach(s -> listView.getItems().add(s.getId() + ". LOGIN: " + s.getLogin() + ", EMAIL: " + s.getEmail() + ", NAME: " + s.getName() + ", SURNAME: " + s.getSurname() + ", ACC NUMBER: " + s.getAccNumber() + ", COURSE IS: " + s.getCourse_is()));
    ...
    public void addStudent(ActionEvent actionEvent) throws SQLException {
        ...
        if (rs.next()) {
            ...
            DbOperations.insertStudent(loginField.getText(), passwordField.getText(), emailField.getText(), nameField.getText(), surnameField.getText(), accNumberField.getText(), Integer.parseInt(courseIsField.getText()));
    ...
    public void deleteStudent(ActionEvent actionEvent) throws SQLException {
        ...
        int id = Integer.parseInt(elements.get(0).substring(0, 2).replace(".", ""));
    ...
    public void updateStudent(ActionEvent actionEvent) throws SQLException {
        ...
        DbOperations.updateStudent(Integer.parseInt(students.get(0)), saveChanges.get(0), saveChanges.get(1), saveChanges.get(2), saveChanges.get(3), saveChanges.get(4), saveChanges.get(5), Integer.parseInt(saveChanges.get(6)));
