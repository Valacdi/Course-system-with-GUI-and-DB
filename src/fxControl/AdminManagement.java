...
public class AdminManagement implements Initializable {
    ...
    public void addAdmin(ActionEvent actionEvent) throws SQLException {
        ...
        if (rs.next()) {
            ...
            DbOperations.insertAdmin(loginField.getText(), pswField.getText(), emailField.getText(), Integer.parseInt(phoneField.getText()), Integer.parseInt(courseISField.getText()));
    ...
    public void updateAdmin(ActionEvent actionEvent) throws SQLException {
        ...
        DbOperations.updateAdmin(Integer.parseInt(admins.get(0)), saveChanges.get(0), saveChanges.get(1), saveChanges.get(2), Integer.parseInt(saveChanges.get(3)), Integer.parseInt(saveChanges.get(4)));
